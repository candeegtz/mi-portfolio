  ...
  resources: {
    en: {
        translation: {
            ...
            button: "Contact me",
            rotatingTexts: ["Desarrolladora IA/ML", "Diseñadora Web", "Desarrolladora de SaaS"],
            cv: "Download CV",
            ...
            newsAnalysisObj: "The primary objective was to evaluate and compare the effectiveness of different Information Retrieval (IR) models (Boolean vs. Free Text using tf-idf) and determine the optimal Natural Language Processing (NLP) techniques (lemmatization, synonyms, stop-word removal) to maximize search performance on the news corpus.",
            ...
            imgCleanerObj: "The main objective is to design and train a robust CNN model (like ViT) capable of accurately classifying images into predefined categories (boards, WhatsApp chats, Instagram captures, Mail, Locations), applying Transfer Learning techniques to achieve high performance with a custom dataset.",
    ...
    es: {
        translation: {
            ...
            newsAnalysisObj: "El objetivo principal fue evaluar y comparar la efectividad de distintos modelos de Recuperación de Información (IR) (Booleano vs. Texto Libre usando tf-idf) y determinar las técnicas de PLN óptimas (lematización, sinónimos, eliminación de stop-words) para maximizar el rendimiento de la búsqueda sobre el corpus de noticias.",
            ...
            imgCleanerObj: "El objetivo principal fue diseñar y entrenar un modelo CNN robusto (como ViT) capaz de clasificar imágenes con alta precisión en las categorías predefinidas (Pizarras, chats de WhatsApp, capturas de Instagram, Mail, Ubicaciones), aplicando técnicas de Transfer Learning para lograr un alto rendimiento con un conjunto de datos personalizado",
            imgCleanerLections: [],
