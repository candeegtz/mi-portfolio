    ...
    return (
        <div className="project-page">
            <header className="project-page-header">
                <h1>News Analysis</h1>
                <p>{t('newsAnalysisIntro')} </p>
                <p>{t('newsAnalysisIntro2')} </p>
            ...
            <section className="project-section">
                ...
                <div>
                    {t("newAnalysisLections", { returnObjects: true }).map((lection, index) => (
            ...
            <section className="project-section">
                ...
                <div className="repo-link-container">
                    <a href="https://github.com/candeegtz/news-analysis" target="_blank" rel="noopener noreferrer" className="repo-link-button">
                        News Analysis
                    </a>
                </div>
            </section>
